...
#include <prefixdb/prefixdb/multidb/options/db_config_json.hpp>
...
struct multidb_config_json
{
  ...
  typedef wjson::object<
    ...
    wjson::member_list<
      ...
      wjson::member<n_allowed_prefixes, multidb_config, std::vector<std::string>, 
                                        &multidb_config::allowed_prefixes, wjson::vector_of_strings<> >,
      wjson::member<n_denied_prefixes, multidb_config, std::vector<std::string>, 
                                        &multidb_config::denied_prefixes, wjson::vector_of_strings<> >,
